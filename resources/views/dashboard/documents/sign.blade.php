...
<div class="container-fluid">
    ...
    <div class="toolbar mb-3">
        <div class="group">
            <button type="button" class="btn btn-primary" id="prevPage">Prev Page</button>
        ...
        <div class="group">
            <a href="{{ asset('storage/' . $document->file_path) }}" target="_blank" class="btn btn-light">Open PDF Directly</a>
        </div>
    </div>
    ...
    <form id="saveForm" method="POST" action="{{ route('dashboard.documents.sign.store', $document->id) }}">
        ...
        <button type="submit" class="btn btn-success mt-3">Save Signature</button>
        <a href="{{ route('dashboard.documents.index') }}" class="btn btn-secondary mt-3">Cancel</a>
    </form>
</div>
