@extends('dashboard.layouts.app') @section('content') @push('css')
<style>
    /* Container & canvas */
    #pageContainer {
        position: relative;
...
<div class="container-fluid">
        ...
        <div class="group">
            ...
            <span class="mx-2"
                ...
                <strong
                    ...
                    <span id="pageCount">0</span></strong
                ></span
            >
    ...
    <div class="row">
        <div class="col-lg-12 d-flex align-items-center gap-2 my-3 flex-wrap">
            ...
            <form id="revisionForm" method="POST"
                ...
                <button type="submit"
                    ...
                    <span class="text">Kirim Revisi</span>
                </button>
            </form>
    ...
    (() => {
        ...
        pdfjsLib
            ...
            .catch((err) => {
                ...
                alert(
                    "Gagal memuat dokumen. Cek URL file atau permission storage.",
                );
            });
        ...
        function scalePagePaths(page, oldScale, newScale) {
            ...
            drawings[page] = drawings[page].map((path) =>
                path.map((pt) => ({ x: pt.x * ratio, y: pt.y * ratio })),
            );
        }
        ...
        function buildSignedPagesData() {
            ...
            for (const pStr of Object.keys(drawings)) {
                ...
                const vw = pageViewports[p]
                    ? Math.round(pageViewports[p].width)
                    : drawCanvas.width;
                const vh = pageViewports[p]
                    ? Math.round(pageViewports[p].height)
                    : drawCanvas.height;
        ...
        document
            ...
            .addEventListener("submit", function (e) {
                ...
                if (Object.keys(signed).length === 0) {
                    if (
                        !confirm(
                            "Tidak ada coretan yang terdeteksi. Tetap simpan tanpa coretan?",
                        )
                    ) {
                        return;
                    }
