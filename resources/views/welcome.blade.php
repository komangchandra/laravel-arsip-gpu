...
<html lang="en">
    ...
    <body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
        <div class="min-h-screen flex flex-col items-center justify-center p-6">
            {{-- Header --}}
            <header
                class="w-full max-w-5xl flex justify-between items-center mb-10"
            >
            ...
            {{-- Main Content --}}
            <main
                class="flex flex-col lg:flex-row bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden max-w-5xl w-full"
            >
                {{-- Left Content --}}
                <div class="flex-1 p-10">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mb-6">
                        Sistem ini digunakan untuk pengelolaan dokumen internal
                        PT. Gorby Putra Utama. Masuk ke akun Anda untuk mulai
                        mengunggah, mengelola, dan meninjau dokumen perusahaan.
                    </p>

                    <ul
                        class="space-y-3 mb-6 text-sm text-gray-700 dark:text-gray-300"
                    >
                ...
                {{-- Right Illustration --}}
                <div
                    class="lg:w-1/2 bg-gradient-to-br from-blue-100 to-blue-300 dark:from-gray-700 dark:to-gray-900 flex items-center justify-center p-6"
                >
                    <img
                        src="{{ asset('images/document-illustration.svg') }}"
